...
func AiNpcRunAllTests() -> ref<AiNpcTestRunner> {
    ...
    AiNpcTestChannelSurface(t);
    AiNpcTestChannelJournalOp(t);
    AiNpcTestChannelClean(t);
    AiNpcTestThreadChoices(t);
    AiNpcTestInjectedRow(t);
    AiNpcTestSharedInbox(t);
    AiNpcTestStrangerVoice(t);
    AiNpcTestDerivedVoiceFile(t);
    AiNpcTestVoiceFormatFrench(t);
    AiNpcTestVoiceFormatLanguages(t);
    AiNpcTestCallTransitions(t);
    AiNpcTestCallOpensOnce(t);
    AiNpcTestCallHearsOnlyItsOwn(t);
