...
# The shape that ships. package.ps1 -Config Release drops AiNpcTests.reds AND
# AiNpcTestSuite.reds -- the assertions and the marker module that says they are there -- which
